...
//            'g-recaptcha-response' => 'required|captcha'
        ...
        //redirect
        return back()->withMessage('Sujet Crée!');
    }
...
//
        ...
        return redirect()->route('thread.show', $thread->id)->withMessage('Mise à jour avec succes!');
...
//        }
        ...
        return redirect()->route('thread.index')->withMessage("Supprimier avec succes!");
    }
    ...
    public function markAsSolution()
    {
        ...
        if ($thread->save()) {
            if (request()->ajax()) {
                return response()->json(['status' => 'success', 'message' => 'marquer comme solution']);
            }
