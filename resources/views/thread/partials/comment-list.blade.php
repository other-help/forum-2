...
@else
    {{--@if(auth()->check())--}}
        {{--@if(auth()->user()->id == $thread->user_id)--}}
            ...
            {{--</form>--}}
            @can('update',$thread)
            <div  class="btn btn-success pull-right" onclick="markAsSolution('{{$thread->id}}','{{$comment->id}}',this)">Marquer commme solution</div>
            @endcan
        {{--@endif--}}
    {{--@endif--}}
...
<div class="actions">
    ...
    <a class="btn btn-primary btn-xs" data-toggle="modal" href="#{{$comment->id}}">modifier</a>
                ...
                <div class="modal-body">
                    <div class="comment-form">
                        ...
                        <form action="{{route('comment.update',$comment->id)}}" method="post" role="form">
                            {{csrf_field()}}
                            {{method_field('put')}}
                            <legend>Modifier Reponse</legend>
    ...
    <form action="{{route('comment.destroy',$comment->id)}}" method="POST" class="inline-it">
        {{csrf_field()}}
        {{method_field('DELETE')}}
        <input class="btn btn-xs btn-danger" type="submit" value="Suprimer">
    </form>
